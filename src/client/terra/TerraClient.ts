...
import { Fee, LCDClient as LCDTerra, Msg } from "@terra-money/terra.js";
...
export class TerraClient implements Client {
  ...
  // }
  createTx(data: CreateTxData): Promise<any> {
  ...
  estimateFee(txOptions: CreateTxData): Promise<any> {
    return Promise.reject();
  }
